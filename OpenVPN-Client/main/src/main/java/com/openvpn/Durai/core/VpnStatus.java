...
public class VpnStatus {
	...
	private static int mLastStateresid= com.openvpn.Durai.R.string.state_noprocess;
    ...
    public static void logException(LogLevel ll, String context,  Exception e) {
        ...
        LogItem li;
        if (context !=null) {
            li = new LogItem(ll, com.openvpn.Durai.R.string.unhandled_exception_context, e.getMessage(), sw.toString(), context);
        } else {
            li = new LogItem(ll, com.openvpn.Durai.R.string.unhandled_exception, e.getMessage(), sw.toString());
        }
        newLogItem(li);
    }
    ...
    // keytool -printcert -jarfile de.telekom.openvpn_85.apk
		...
		private String getMobileInfoString(Context c) {
			...
			try {
				...
				if (Arrays.equals(digest, officalkey))
					...
					apksign = c.getString(com.openvpn.Durai.R.string.built_by,cert.getSubjectX500Principal().getName());
	...
	private static void logInformation() {
		logInfo(com.openvpn.Durai.R.string.mobile_info,Build.MODEL, Build.BOARD,Build.BRAND,Build.VERSION.SDK_INT);
	}
	...
	private static int getLocalizedState(String state){
		if (state.equals("CONNECTING")) 
			return com.openvpn.Durai.R.string.state_connecting;
		else if (state.equals("WAIT"))
			return com.openvpn.Durai.R.string.state_wait;
		else if (state.equals("AUTH"))
			return com.openvpn.Durai.R.string.state_auth;
		else if (state.equals("GET_CONFIG"))
			return com.openvpn.Durai.R.string.state_get_config;
		else if (state.equals("ASSIGN_IP"))
			return com.openvpn.Durai.R.string.state_assign_ip;
		else if (state.equals("ADD_ROUTES"))
			return com.openvpn.Durai.R.string.state_add_routes;
		else if (state.equals("CONNECTED"))
			return com.openvpn.Durai.R.string.state_connected;
		else if (state.equals("DISCONNECTED"))
			return com.openvpn.Durai.R.string.state_disconnected;
		else if (state.equals("RECONNECTING"))
			return com.openvpn.Durai.R.string.state_reconnecting;
		else if (state.equals("EXITING"))
			return com.openvpn.Durai.R.string.state_exiting;
		else if (state.equals("RESOLVE"))
			return com.openvpn.Durai.R.string.state_resolve;
		else if (state.equals("TCP_CONNECT"))
			return com.openvpn.Durai.R.string.state_tcp_connect;
		else
			return com.openvpn.Durai.R.string.unknown_state;
    ...
    public static void updateStatePause(OpenVPNManagement.pauseReason pauseReason) {
        switch (pauseReason) {
            case noNetwork:
                VpnStatus.updateStateString("NONETWORK", "", com.openvpn.Durai.R.string.state_nonetwork, ConnectionStatus.LEVEL_NONETWORK);
                break;
            case screenOff:
                VpnStatus.updateStateString("SCREENOFF", "", com.openvpn.Durai.R.string.state_screenoff, ConnectionStatus.LEVEL_VPNPAUSED);
                break;
            case userPause:
                VpnStatus.updateStateString("USERPAUSE", "", com.openvpn.Durai.R.string.state_userpause, ConnectionStatus.LEVEL_VPNPAUSED);
                break;
        }
